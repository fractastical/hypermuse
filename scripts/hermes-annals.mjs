...
function promptFor(facts, media) {
  return [
    "You are writing one dated entry in the Annals of Hermes, the logbook of an art car",
    ...
    "- Name places and installations exactly as given.",
    "- 90 to 160 words, past tense, one paragraph, plain and specific rather than lyrical.",
    ...
    "The headline is at most 60 characters and names the day's one real event.",
    "",
    "Facts:",
