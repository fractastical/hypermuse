...
TODO 
    ...
    pick out stems and allow you to play all at same time (mabye by folder)
        - each stem creates a separate sonic sphere
        - all start at the same time
        - controller can be set to their spacing

    hypergraph repsentatino 
